    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <form method="POST" action="{{ route('expenses.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div id="file-info" class="mt-1 hidden flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                            <i id="file-icon" class="fas fa-file text-blue-600 text-sm"></i>
                        </div>
                        <div>
                            <p id="file-name" class="text-sm font-medium text-gray-900">File name</p>
