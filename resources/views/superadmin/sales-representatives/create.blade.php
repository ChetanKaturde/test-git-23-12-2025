...
@section('title', 'Add Sales Representative - Super Admin')
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
                ...
                <p class="page-subtitle">Create a new sales representative profile</p>
            </div>
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form method="POST" action="{{ route('superadmin.sales-representatives.store') }}">
            @csrf
