...
<body>
    <div class="container">
        <h2>🏭 Monitorbizz Registration</h2>
        
        <div class="notice">
            <strong>Note:</strong> Registration is currently disabled. Please contact the administrator for access.
        </div>
        ...
        <form>
            ...
            <button type="button" class="btn" disabled>Register Account</button>
        </form>
